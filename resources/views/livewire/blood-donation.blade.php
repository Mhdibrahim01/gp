                ...
                <div class=" my-5 p-lg-3 shadow ">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="input-group mb-3 pe-4">
                            ...
                            <label class="input-group-text" for="inputGroupSelect0">المركز</label>
                        ...
                        <div class="input-group mb-3 ps-4 pe-4">
                            ...
                            <label class="input-group-text" for="inputGroupSelect02">المحافظة</label>
...
<div>    <div class="container p-lg-5 shadow">
        <div class="d-flex justify-content-center pb-2">
            <h1 class="h3">ابحث عن المتبرعين بالدم في منطقتك</h1>
        </div>
        <div class="d-flex">
            <div class="input-group mb-3 ps-4 pe-4">
                <select class="form-select" id="inputGroupSelect0" wire:model="selectedGov" wire:change="changeGov">
                    <option value="-1">{{ __('select_gov') }}</option>
                    @foreach ($governments as $id => $name)
                        <option value="{{ $id }}">{{ $name }}</option>
                    @endforeach
